...
新增包：`src/main/java/com/tcode/snapshot/`
...
```text
~/.tcode/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dtcode.snapshot.enabled=false
-Dtcode.snapshot.max=50
-Dtcode.snapshot.excludes=...
```
