...
```text
src/main/java/com/tcode/prompt/
...
2. 用户级覆盖：`~/.tcode/prompts/...`
3. 项目级覆盖：`.tcode/prompts/...`

例如：

```text
~/.tcode/prompts/base.md
~/.tcode/prompts/modes/agent.md
.tcode/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.tcode/prompts/...`
- [x] 支持项目级覆盖 `.tcode/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
