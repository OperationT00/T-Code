...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        TCodeConfig config = new TCodeConfig();
        config.getProviders().put("glm",
                new TCodeConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new TCodeConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new TCodeConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        TCodeConfig config = new TCodeConfig();
        config.getProviders().put("unknown", new TCodeConfig.ProviderConfig("test-key", null, "unknown-model"));
