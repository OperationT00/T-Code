package com.tcode.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[tcode] stdout reader stopped: " + e.getMessage());
            }
        }, "tcode-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[tcode] stderr reader stopped: " + e.getMessage());
            }
        }, "tcode-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
