...
public class VectorStore implements AutoCloseable {
    ...
    public VectorStore(String projectPath) throws SQLException {
        ...
        String dbDir = System.getProperty("tcode.rag.dir",
                System.getProperty("user.home") + "/.tcode/rag");
    ...
    private static String normalizeProjectPath(String projectPath) {
        return Paths.get(projectPath).toAbsolutePath().normalize().toString().replace('\\', '/');
    }
