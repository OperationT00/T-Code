...
import com.tcode.tui.pane.CenterPane;
import com.tcode.tui.pane.FileTreePane;
import com.tcode.tui.pane.InputBar;
import com.tcode.tui.pane.StatusPane;
...
public class RootPane extends Panel {
    ...
    private final TCodeConfig config;
     ...
     */
    public RootPane(TCodeConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.tcode/history/。");
            return true;
        }
