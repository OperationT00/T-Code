...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.tcode.skill.SkillRegistry skillRegistry,
                               com.tcode.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "tcode-multi-agent");
            t.setDaemon(true);
            return t;
        });
