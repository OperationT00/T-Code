...
import com.tcode.prompt.PromptContext;
import com.tcode.prompt.PromptMode;
import com.tcode.render.PlainRenderer;
...
import com.tcode.skill.SkillIndexFormatter;
import com.tcode.skill.SkillRegistry;
import com.tcode.util.AnsiStyle;
import com.tcode.tool.ToolRegistry;
import com.tcode.tool.ToolRegistry.ToolExecutionResult;
import com.tcode.tool.ToolRegistry.ToolInvocation;
import com.tcode.util.TerminalMarkdownRenderer;
import com.tcode.image.ImageReferenceParser;
...
public class Agent {
    ...
    public String getContextStatus() {
        com.tcode.context.ContextProfile profile = memoryManager.getContextProfile();
    ...
    private int estimateToolsSchemaTokens() {
        try {
            return com.tcode.memory.MemoryEntry.estimateTokens(
    ...
    private void logRequestContext(String scope, List<LlmClient.Tool> tools) {
        ...
        if (tools != null && !tools.isEmpty()) {
            try {
                toolsSchemaTokens = com.tcode.memory.MemoryEntry.estimateTokens(
