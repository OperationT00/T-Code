...
import com.tcode.mcp.mention.AtMentionCompleter;
...
final class TCodeCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    TCodeCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
